function addRecidentialsForm(id){
var tmpHtml = ''+
	'<table>'+
		'<tr>'+
		...
		'<tr>'+
			...
			'<td><input type="text"  id="google_city" data-column ="city"  class="form-control res_form_input">'+
			'</td>'+
		'</tr>'+
		'</tr>'+
			'<td></td>'+
			'<td>'+
				'X:<input type="text" id="latt" disabled data-column ="latt"  style="width:40%;display:inline-block;" type="text"  class="form-control res_form_input">'+
				'  Y:<input type=" text" id="long" disabled data-column ="lng"  style="width:40%;display:inline-block;" type="text"  class="form-control res_form_input">'+
			'</td>'+
		'</tr>'+
		'<tr>'+
		...
		'<tr>'+
			...
			'<td><div class="input-group"><input type="text"  data-column ="number_of_room"  class="form-control res_form_input"><div></td>'+
		'</tr>'+
		'<tr>'+
		...
		'<tr>'+
			...
			'<td><div class="input-group"><input type="text"  data-column ="rent"  class="form-control res_form_input"><span class="input-group-addon">AED</span></div>'+
			'<label>'+
		...
		'<tr>'+
			...
			'</td>'+
		'</tr>'+
		'<tr><td colspan="2" style="text-align:center;"><button class="btn btn-primary" id="res_add">Add</button>&nbsp;&nbsp;&nbsp;<button  id="reset" class="btn btn-secondary">Reset</button> </td></tr>'+
	'</table><div id="dZUpload" class="dropzone"><div class="dz-default dz-message"></div></div>';
	
	$("#"+id).html(tmpHtml);
	
	$("body").undelegate("#reset","click")
	$("body").delegate("#reset","click",function(e){
		addRecidentialsForm("add_res_property_form");
	})
	$(document).undelegate("#res_add","click");
